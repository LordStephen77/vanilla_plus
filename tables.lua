...
minetest.register_node("vanilla_plus:table_wooden_planks", {
...
minetest.register_node("vanilla_plus:table_pine_wood", {
...
minetest.register_node("vanilla_plus:table_acacia_wood", {
...
minetest.register_node("vanilla_plus:table_aspen_wood", {
...
minetest.register_node("vanilla_plus:table_jungle_wood", {
