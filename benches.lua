...
minetest.register_node("vanilla_plus:bench_wooden_planks", {
...
minetest.register_node("vanilla_plus:bench_pine_wood", {
...
minetest.register_node("vanilla_plus:bench_acacia_wood", {
...
minetest.register_node("vanilla_plus:bench_aspen_wood", {
...
minetest.register_node("vanilla_plus:bench_jungle_wood", {
