...
minetest.register_craft({
	output = "vanilla_plus:table_wooden_planks 1",
	recipe = {
...
minetest.register_craft({
	output = "vanilla_plus:table_pine_wood 1",
	recipe = {
...
minetest.register_craft({
	output = "vanilla_plus:table_aspen_wood 1",
	recipe = {
...
minetest.register_craft({
	output = "vanilla_plus:table_acacia_wood 1",
	recipe = {
...
minetest.register_craft({
	output = "vanilla_plus:table_jungle_wood 1",
	recipe = {
