...
minetest.register_node("vanilla_plus:chair_wooden_planks", {
...
minetest.register_node("vanilla_plus:chair_pine_wood", {
...
minetest.register_node("vanilla_plus:chair_acacia_wood", {
...
minetest.register_node("vanilla_plus:chair_aspen_wood", {
...
minetest.register_node("vanilla_plus:chair_jungle_wood", {
